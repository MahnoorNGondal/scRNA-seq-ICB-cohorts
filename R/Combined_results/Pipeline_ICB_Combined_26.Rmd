...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/vln2.png", width = 15, height=10)

FeatureScatter(merged_tissue_cluster_update, "nCount_RNA", "nFeature_RNA", group.by = "Study_name", pt.size = 0.5)

ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/FS2.png", width = 15, height=10)

before_filtering <- merged_tissue_cluster_update
### Filtering
...
merged_tissue_cluster_update_filt <- subset(merged_tissue_cluster_update, features = selected_f)
...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/vln1afterfilter3.png", width = 10, height=4)
```
...
merged_filtered_tissue_cluster <- readRDS("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_10_23_08_23/merged_filtered_tissue_cluster_2DF.RDS") ## after_DF_filtering
...
merged_filtered_tissue_cluster_md$logUMI <- log(merged_filtered_tissue_cluster_md$nCount_RNA)
  ...
  b <- ggboxplot(merged_filtered_tissue_cluster_md, x = "DoubletFinder", y = "logUMI", add = "none", fill = "DoubletFinder", palette = mycols) + theme_classic()   +                                                               # Change font size
  theme(strip.text.x = element_text(size = 15)) + theme(strip.text.y = element_text(size = 15))  + ylab("log nCount_RNA")  +
  ...
  theme(strip.text.x = element_text(size = 15)) + theme(text = element_text(size = 20))  + theme(legend.position = "none")  + theme(axis.text.x = element_text(angle = 90, vjust = 1, hjust=1))  +
       theme(axis.text.x=element_text(size=20, angle=90,hjust=0.95,vjust=0.2)) + facet_wrap(~Study_name, nrow  = 1) + 
    theme(axis.text.x = element_text( colour = "black")) + 
    theme(axis.text.y = element_text( colour = "black")) + theme(strip.text = element_text(size = 15)) 
b

ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/DF.png",  width =18, height=4)
...
after_DF_filtering <- subset(merged_filtered_tissue_cluster, 
...
merged_filtered_tissue_cluster_sig <-  subset(x = merged_filtered_tissue_cluster_sig, subset = enough_cells == "enough") ## after_CC_filtering
...
after_CC_filtering_md <- after_CC_filtering@meta.data
...
combined <- rbind(before_filtering_md_agg, 
                  ...
                  after_DF_filtering_md_agg,
                  after_CC_filtering_md_agg)

  combined$QC <- factor (combined$QC, levels = c ("Before_QC", "MT_filter", "RP[SL]_filter", "DF_filter", "CC_filter"))
...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/QC.png",  width =7, height=6)
```
...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/umap_studyname.png",  width =8, height=5)

merged_filtered_tissue_cluster_sig$Study_name_cancer2 <- ifelse(merged_filtered_tissue_cluster_sig$Study_name_cancer == "Alvarez_Breckenridge:MBM",
                                                                "Alvarez:MBM", merged_filtered_tissue_cluster_sig$Study_name_cancer)

p2 <-  DimPlot(merged_filtered_tissue_cluster_sig, reduction = "umap", group.by = "Study_name_cancer2", label = TRUE, pt.size = 0.4, label.size = 5, repel = TRUE) + labs(title = bquote('ICB-treated study and cancer types: 11'))  + theme(plot.title=element_text(hjust=0.5, vjust=0.1 )) +  theme(plot.title = element_text(size=15)) +
  labs(color = "Study:Cancertype")  +theme(legend.position = "right", 
               legend.text = element_text(size = 15))  +theme(axis.text.x=element_text(size=15))+theme(axis.text.y=element_text(size=15)) +theme(legend.title = element_text(size=15))+
  theme(legend.text = element_text(size=15)) +theme(axis.text.x=element_text(size=15))+theme(axis.text.y=element_text(size=15))   + theme(text = element_text(size = 15)) 
# +
#   guides(color=guide_legend(nrow=4, ncol = 4, byrow=TRUE, bycol= TRUE, title="Groups"))

ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/umap_Cancer_type_update.png",  width =8, height=5)


p3 <-  DimPlot(merged_filtered_tissue_cluster_sig, reduction = "umap", group.by = "pre_post", label = FALSE, pt.size = 0.4, label.size = 6, repel = TRUE) + labs(title = bquote('Pre and post samples'))  + theme(plot.title=element_text(hjust=0.5, vjust=0.1 )) +  theme(plot.title = element_text(size=15)) +
...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/pre_post.png",  width =8, height=5)

merged_filtered_tissue_cluster_sig@active.ident <- factor(merged_filtered_tissue_cluster_sig@active.ident,
                                                           levels=c( "Favourable", "Unfavourable",  "UT", "n/a"))

p4 <-  DimPlot(merged_filtered_tissue_cluster_sig, reduction = "umap", group.by = "Combined_outcome", label = FALSE, pt.size = 0.4, label.size = 6, repel = TRUE) + labs(title = bquote('Combined_outcome'))  + theme(plot.title=element_text(hjust=0.5, vjust=0.1 )) +  theme(plot.title = element_text(size=15)) +
  labs(color = "Combined_outcome")  +theme(legend.position = "right", 
               legend.text = element_text(size = 15))  +theme(axis.text.x=element_text(size=15))+theme(axis.text.y=element_text(size=15)) +theme(legend.title = element_text(size=15))+
  theme(legend.text = element_text(size=15)) +theme(axis.text.x=element_text(size=15))+theme(axis.text.y=element_text(size=15))   + theme(text = element_text(size = 15)) 
# +
#   guides(color=guide_legend(nrow=4, ncol = 4, byrow=TRUE, bycol= TRUE, title="Groups"))

ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/Combined_outcome.png",  width =8, height=5)


g <- grid.arrange( p3, p4, ncol = 2)

ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/uamps.png", g, width =15, height=5)
```
...
pie1 <- ggplot(merged_filtered_tissue_cluster_sig_md_agg, aes(x = "", y = Freq, fill = Var1)) + 
  ...
  ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/piechartpatient.png", width =7, height=4)
...
#   theme(legend.text = element_text(size=15))  + theme(text = element_text(size = 15)) 
#   
#   ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/piechartCELLS.png", width =7, height=7)
...
#   labs(fill = "# Patients")
#   
#   ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/piechartpre_postCELLS.png", width =7, height=7)
  
  ######################
#   
#   
#     merged_filtered_tissue_cluster_sig_md_agg <- data.frame((aggregate(cbind(Combined_outcome == Combined_outcome) ~  Combined_outcome, merged_filtered_tissue_cluster_sig_md, length)))
# 
#   merged_filtered_tissue_cluster_sig_md_agg <- merged_filtered_tissue_cluster_sig_md_agg   %>%
#   mutate(pct= prop.table(V1) * 100) 
#   
#   merged_filtered_tissue_cluster_sig_md_agg <- merged_filtered_tissue_cluster_sig_md_agg %>%
#   arrange(desc(Combined_outcome)) %>%
#   mutate(lab.ypos = cumsum(pct) - 0.5*pct)
#   
#   mycols <- c("#0073C2FF", "#EFC000FF", "#868686FF", "#CD534CFF", mycolors)
# 
#  merged_filtered_tissue_cluster_sig_md_agg$pct <- round(merged_filtered_tissue_cluster_sig_md_agg$pct, 2) 
#  pie4 <- ggplot(merged_filtered_tissue_cluster_sig_md_agg, aes(x = "", y = V1, fill = Combined_outcome)) + 
#   geom_bar(stat = "identity", width = 1, position = position_fill(), color = "white") +
#   coord_polar(theta = "y", start =5)+
#   geom_col(color = "black")  +
#   theme_void()+ theme(text = element_text(size = 15))+
...
#  pie4
#   
#   ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/piechartOutcomeCELLS.png", width =7, height=7)
#   
#   ##
#   
#     merged_filtered_tissue_cluster_sig_md_agg_pre <- data.frame((aggregate(cbind(pre_post == pre_post) ~ sample_id  +pre_post, merged_filtered_tissue_cluster_sig_md, length)))
#     # merged_filtered_tissue_cluster_sig_md_agg_pre <- data.frame((aggregate(cbind(pre_post == pre_post) ~ pre_post, merged_filtered_tissue_cluster_sig_md_agg_pre, length)))
# 
#       merged_filtered_tissue_cluster_sig_md_agg_pre <- merged_filtered_tissue_cluster_sig_md_agg_pre   %>%
#   mutate(pct= prop.table(V1) * 100) 
#   
#   merged_filtered_tissue_cluster_sig_md_agg_pre <- merged_filtered_tissue_cluster_sig_md_agg_pre %>%
#   arrange(desc(pre_post)) %>%
...
#   mycols <- c("#0073C2FF", "#EFC000FF", "#868686FF", "#CD534CFF", mycolors)
# 
# merged_filtered_tissue_cluster_sig_md_agg_pre$pct <- round(merged_filtered_tissue_cluster_sig_md_agg_pre$pct, 2) 
# pie3 <-   ggplot(merged_filtered_tissue_cluster_sig_md_agg_pre, aes(x = "", y = V1, fill = pre_post)) + 
#   geom_bar(stat = "identity", width = 1, position = position_fill(), color = "white") +
#   coord_polar(theta = "y", start =5)+
#   geom_col(color = "black")  +
#   theme_void()+ theme(text = element_text(size = 15))+
...
#   labs(fill = "# Patients")
#   
#   ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/piechartpre_postCELLSpatients.png", width =7, height=7)
  
  
    merged_filtered_tissue_cluster_sig_md_dup <- merged_filtered_tissue_cluster_sig_md[!duplicated(merged_filtered_tissue_cluster_sig_md$sample_id_pre_post), ]

merged_filtered_tissue_cluster_sig_md_agg <- data.frame(table(aggregate(cbind(pre_post == pre_post) ~ pre_post + sample_id, merged_filtered_tissue_cluster_sig_md_dup, length)$pre_post))
...
pie1 <- ggplot(merged_filtered_tissue_cluster_sig_md_agg, aes(x = "", y = Freq, fill = Var1)) + 
  ...
  ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/piechartpreepost.png", width =7, height=4)
  
  
  
  merged_filtered_tissue_cluster_sig_md_agg <- data.frame(table(aggregate(cbind(Combined_outcome == Combined_outcome) ~ Combined_outcome + sample_id, merged_filtered_tissue_cluster_sig_md_dup, length)$Combined_outcome))
...
pie1 <- ggplot(merged_filtered_tissue_cluster_sig_md_agg, aes(x = "", y = Freq, fill = Var1)) + 
  ...
  ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_20_10_01_24/piechartCombined_outcome.png", width =7, height=4)
```
...
T_cell <- c(	"CD3D", "GZMA", "CD3E")
B_cell <- c("CD19", "MS4A1", "BANK1", "BLK", "IRF8")
# Macro_Mono_DC <- c()
...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/DOTPLOT_markers.png", width = 8.5, height=4)
