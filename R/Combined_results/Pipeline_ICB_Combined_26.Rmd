...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/umap_studyname.png",  width =8, height=5)
...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/umap_Cancer_type_update.png",  width =8, height=5)
...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/pre_post.png",  width =8, height=5)
...
p4 <-  DimPlot(merged_filtered_tissue_cluster_sig, reduction = "umap", group.by = "Combined_outcome", label = TRUE, pt.size = 0.4, label.size = 5, repel = TRUE) + labs(title = bquote('Outcomes'))  + theme(plot.title=element_text(hjust=0.5, vjust=0.1 )) +  theme(plot.title = element_text(size=15)) +
...
ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/Combined_outcome.png",  width =8, height=5)


g <- grid.arrange(p1, p2, p3, p4, ncol = 2)

ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/uamps.png", g, width =15, height=10)
```


## piecharts
```{r}
mycolors = c(brewer.pal(name="Dark2", n = 8), brewer.pal(name="Paired", n = 12), brewer.pal(name="Set2", n = 12), brewer.pal(name="RdBu", n = 2), brewer.pal(name="Set1", n = 12), brewer.pal(name="Accent", n = 8), brewer.pal(name="Accent", n = 8))
...
pie1 <- ggplot(merged_filtered_tissue_cluster_sig_md_agg, aes(x = "", y = Freq, fill = Var1)) + 
  ...
  ggsave("/mctp/share/users/gondal/01_scHLA/03_output/ICI_Combined/version_19_19_12_23/piechartpatient.png", width =7, height=7)
